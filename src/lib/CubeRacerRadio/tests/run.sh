...
"${CXX:-g++}" -std=gnu++11 -g -ffunction-sections -fdata-sections "$gc_sections" \
    -include lib/CubeRacerRadio/tests/include/native_debug.h -DUNIT_TEST -DCUBERACER_RADIO_HAL_TEST -DCUBERACER_M4 -DPLATFORM_STM32 -DTARGET_NATIVE -DPROGMEM= \
...
python3 variants/CUBERACER_M4/tests/test_stats_publish.py
