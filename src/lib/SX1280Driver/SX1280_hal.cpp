...
void SX1280Hal::init()
{
    ...
    if (GPIO_PIN_RST != UNDEF_PIN) pinMode(GPIO_PIN_RST, OUTPUT);
    if (GPIO_PIN_RST_2 != UNDEF_PIN) pinMode(GPIO_PIN_RST_2, OUTPUT);
    ...
    SPIEx.begin();
    SPIEx.beginTransaction(SPISettings(17500000, MSBFIRST, SPI_MODE0));
#endif
